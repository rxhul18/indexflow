...
const QNS_API_ENDPOINT =
  process.env.NODE_ENV == "development"
    ? "http://localhost:3001/v1/bot/index/qns/all"
    : "https://api.indexflow.site/v1/bot/index/qns/all";
const ANS_API_ENDPOINT =
  process.env.NODE_ENV == "development"
    ? "http://localhost:3001/v1/bot/index/ans/all"
    : "https://api.indexflow.site/v1/bot/index/ans/all";
