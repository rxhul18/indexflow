...
.use(checkBot)
  .get("/", async (c) => {
    ...
    return c.json({ message: "Database Statistics", UsersCount: dbUsersCount, AnonProfilesCount: dbAnonCount, TagsCount: dbTagsCount, QuestionsCount: dbIndexQnsCount, AnswersCount: dbIndexAnsCount, ServersCount: dbServersCount, ConfigsCount: dbConfiguredServersCount });
  })
